...
ArgoCD polls the repository every 30 seconds. If you want to skip that wait, you can force an immediate refresh by running:
...
To trigger ArgoCD without waiting up to 30 seconds:
